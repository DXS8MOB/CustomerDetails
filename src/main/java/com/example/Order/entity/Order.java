...
public class Order {
	...
	@NotNull
	@NotBlank(message = Constants.ORDERID_NOT_NULL)
	@Column(name = "orderid", unique = true)
	private String orderid;

	@NotNull
	@NotBlank(message = Constants.ORDERDESC_NOT_BLANK)
	@Column(name = " order_desc")
	private String order_desc;

	@NotNull
	@NotBlank(message = Constants.PURCHASEDATE_NOT_BLANK)
	@Column(name = " purchase_date")
	private String purchase_date;

	@NotNull
	@NotBlank(message = Constants.PURCHASEPRICE_NOT_BLANK)
